...
class Theme_Option {
    ...
    public $option_control_type = 'text';
    ...
    public function __construct($args = null){
        if(isset($args)){
            ...
            $this->option_type = $args['option_type']??$this->option_type;
            ...
            $this->option_control_type = $args['option_control_type']??$this->option_control_type; 
