...
Class Theme_View_Front_Page extends Abstract_Theme_View {
                                                ...
                                                <article class="row g-0">
                                                    ...
                                                    <div class="col-md-8 card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <p class="col card-text"><small class="text-muted">Rating: <?php $this->get_view_part('ratingbox')->render(['rating' => $rating])?></small></p>
                                                        </div>
                                                    </div>
                                                </article>
                                            </a>
