...
Class Theme_View_404 extends Abstract_Theme_View {
    ...
    public function render($params = null):void{
        ?>
            ...
            <?php wp_body_open(); ?>
                ...
                <section class="ufo">
                            <img src="<?php echo get_stylesheet_directory_uri().'/assets/img/4.svg'?>" alt="number 4" class="number4">
                            <svg class="main-ufo"
                                width="776"
                                height="776"
                                viewBox="0 0 776 776"
                                ...
                                <circle
                                    style="fill:#d4e3ee;fill-opacity:1;stroke-width:1.75717"
                                    id="path1299"
                                    cx="393.64883"
                                    cy="298.43201"
                                    r="228.55945" />
                                ...
                                <g
                                    ...
                                    transform="translate(5.17383,-15.850663)">
                                    <path
                ...
                <section>
                            <img src="<?php echo get_stylesheet_directory_uri().'/assets/img/notfound.svg'?>" alt="Not found title" class="nofound">
                </section>
